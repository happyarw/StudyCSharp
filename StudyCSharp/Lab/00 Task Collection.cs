...
{
    internal class _00_Task_Collection
    {
        // Hello my Friends!

        // Here you'll find my task collection, i've done so far.
        // Every task has a purpouse, so you can learn something from it, it can be anything like datastructure or algorithms.
